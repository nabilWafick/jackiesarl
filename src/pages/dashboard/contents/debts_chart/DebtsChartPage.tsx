...
const DebtsChartPage = () => {
  return (
    <div className="h-full w-full flex flex-col">
      <div className="flex my-1 justify-between items-center">
        <p className="text-lg   ">Evolution des flux de créances</p>
