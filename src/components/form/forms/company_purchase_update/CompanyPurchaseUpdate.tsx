...
import useCompanyPurchaseUpdateForm from "../../../../hooks/forms/company_purchase_update/useCompanyPurchaseUpdateForm";

interface CompanyPurchasseUpdateProps {
  bcNumber: string;
  category: string;
...
const CompanyPurchasseUpdate: FC<CompanyPurchasseUpdateProps> = ({
  bcNumber,
  category,
  purchasedQuantity,
  amount,
...
export default CompanyPurchasseUpdate;
